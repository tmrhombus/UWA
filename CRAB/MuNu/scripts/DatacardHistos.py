...
#####
 ...
 if eventTreeLocation == 'muNuEventTree/eventTree' :
  ...
  tb_tihNo.SetName("tb_tihNo")
  t_sihNo   = t_sih.Clone()
  t_sihNo.SetName("t_sihNo")
  tb_sihNo  = tb_sih.Clone()
  tb_sihNo.SetName("tb_sihNo")
  t_twihNo  = t_twih.Clone()
  t_twihNo.SetName("t_twihNo")
  tb_twihNo = tb_twih.Clone()
  tb_twihNo.SetName("tb_twihNo")
  ttbihNo   = ttbih.Clone()
 ...
 if eventTreeLocation == 'muNuEventTreeMuonUp/eventTree' :
  ...
  tb_tihmUP.SetName("tb_tihmUP")
  t_sihmUP   = t_sih.Clone()
  t_sihmUP.SetName("t_sihmUP")
  tb_sihmUP  = tb_sih.Clone()
  tb_sihmUP.SetName("tb_sihmUP")
  t_twihmUP  = t_twih.Clone()
  t_twihmUP.SetName("t_twihmUP")
  tb_twihmUP = tb_twih.Clone()
  tb_twihmUP.SetName("tb_twihmUP")
  ttbihmUP   = ttbih.Clone()
  ttbihmUP.SetName("ttbihmUP")
  wlihmUP    = wlnih.Clone()
  wlihmUP.SetName("wlihmUP")
  wlihmUP.Add(wl1ih)
  wlihmUP.Add(wl2ih)
  wlihmUP.Add(wl3ih)
  wlihmUP.Add(wl4ih)
  wcihmUP    = wcnih.Clone()
  wcihmUP.SetName("wcihmUP")
  wcihmUP.Add(wc1ih)
  wcihmUP.Add(wc2ih)
  wcihmUP.Add(wc3ih)
  wcihmUP.Add(wc4ih)
  wccihmUP   = wccnih.Clone()
  wccihmUP.SetName("wccihmUP")
  wccihmUP.Add(wcc1ih)
  wccihmUP.Add(wcc2ih)
  wccihmUP.Add(wcc3ih)
  wccihmUP.Add(wcc4ih)
  wbbihmUP   = wbbnih.Clone()
  wbbihmUP.SetName("wbbihmUP")
  wbbihmUP.Add(wbb1ih)
  wbbihmUP.Add(wbb2ih)
  wbbihmUP.Add(wbb3ih)
  wbbihmUP.Add(wbb4ih)
 if eventTreeLocation == 'muNuEventTreeMuonDown/eventTree' : 
  ...
  tb_tihmDN.SetName("tb_tihmDN")
  t_sihmDN   = t_sih.Clone()
  t_sihmDN.SetName("t_sihmDN")
  tb_sihmDN  = tb_sih.Clone()
  tb_sihmDN.SetName("tb_sihmDN")
  t_twihmDN  = t_twih.Clone()
  t_twihmDN.SetName("t_twihmDN")
  tb_twihmDN = tb_twih.Clone()
  tb_twihmDN.SetName("tb_twihmDN")
  ttbihmDN   = ttbih.Clone()
  ttbihmDN.SetName("ttbihmDN")
  wlihmDN    = wlnih.Clone()
  wlihmDN.SetName("wlihmDN")
  wlihmDN.Add(wl1ih)
  wlihmDN.Add(wl2ih)
  wlihmDN.Add(wl3ih)
  wlihmDN.Add(wl4ih)
  wcihmDN    = wcnih.Clone()
  wcihmDN.SetName("wcihmDN")
  wcihmDN.Add(wc1ih)
  wcihmDN.Add(wc2ih)
  wcihmDN.Add(wc3ih)
  wcihmDN.Add(wc4ih)
  wccihmDN   = wccnih.Clone()
  wccihmDN.SetName("wccihmDN")
  wccihmDN.Add(wcc1ih)
  wccihmDN.Add(wcc2ih)
  wccihmDN.Add(wcc3ih)
  wccihmDN.Add(wcc4ih)
  wbbihmDN   = wbbnih.Clone()
  wbbihmDN.SetName("wbbihmDN")
  wbbihmDN.Add(wbb1ih)
  wbbihmDN.Add(wbb2ih)
  wbbihmDN.Add(wbb3ih)
  wbbihmDN.Add(wbb4ih)
 if eventTreeLocation == 'muNuEventTreeJetUp/eventTree' : 
  ...
  tb_tihjUP.SetName("tb_tihjUP")
  t_sihjUP   = t_sih.Clone()
  t_sihjUP.SetName("t_sihjUP")
  tb_sihjUP  = tb_sih.Clone()
  tb_sihjUP.SetName("tb_sihjUP")
  t_twihjUP  = t_twih.Clone()
  t_twihjUP.SetName("t_twihjUP")
  tb_twihjUP = tb_twih.Clone()
  tb_twihjUP.SetName("tb_twihjUP")
 ...
 if eventTreeLocation == 'muNuEventTreeJetDown/eventTree' : 
  ...
  tb_tihjDN.SetName("tb_tihjDN")
  t_sihjDN   = t_sih.Clone()
  t_sihjDN.SetName("t_sihjDN")
  tb_sihjDN  = tb_sih.Clone()
  tb_sihjDN.SetName("tb_sihjDN")
  t_twihjDN  = t_twih.Clone()
  t_twihjDN.SetName("t_twihjDN")
  tb_twihjDN = tb_twih.Clone()
  tb_twihjDN.SetName("tb_twihjDN")
