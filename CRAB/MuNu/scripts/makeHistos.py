...
NonIso = 'isoMuPF>=0.'+str(antiIso_value)
...
ttfilename = '../data/T_tW.root'
tsfilename = '../data/T_tW.root'
ttwfilename = '../data/T_tW.root'
stfilename = '../data/Singletop_tW.root'
ttbfilename = '../data/TTJets.root'
dfilename = '../data/T_tW.root'
...
###
print('w Iso')
wih,wtihSize,wtihSizePart = h.gram(wTree,leaf,xmin,xmax,steps,CutsMCi,I,F)
wih.SetName('wih')
wih.Scale(vScale)
print('  '+str(wihSize))
