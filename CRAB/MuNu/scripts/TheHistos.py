...
data_filename     = '../data/post_synch_v5/Filtered_Data.root'
t_t_filename      = '../data/post_synch_v5b/Filtered_T_t.root'
t_s_filename      = '../data/post_synch_v5b/Filtered_T_s.root'
t_tw_filename     = '../data/post_synch_v5b/Filtered_T_tW.root'
tb_t_filename     = '../data/post_synch_v5b/Filtered_Tbar_t.root'
tb_s_filename     = '../data/post_synch_v5b/Filtered_Tbar_s.root'
tb_tw_filename    = '../data/post_synch_v5b/Filtered_Tbar_tW.root'
tt_semi_filename  = '../data/post_synch_v5b/Filtered_TTbar_semi.root'
tt_full_filename  = '../data/post_synch_v5b/Filtered_TTbar_full.root'
ww_filename       = '../data/post_synch_v5b/Filtered_WW.root'
wz_filename       = '../data/post_synch_v5b/Filtered_WZ.root'
zz_filename       = '../data/post_synch_v5b/Filtered_ZZ.root'
wn_filename       = '../data/post_synch_v5b/Filtered_WJets.root'
w1_filename       = '../data/post_synch_v5b/Filtered_W1Jet.root'
w2_filename       = '../data/post_synch_v5b/Filtered_W2Jet.root'
w3_filename       = '../data/post_synch_v5b/Filtered_W3Jet.root'
w4_filename       = '../data/post_synch_v5b/Filtered_W4Jet.root'
z_filename        = '../data/post_synch_v5b/Filtered_Drell.root'
