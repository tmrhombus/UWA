...
def cutmaker(leaf='J1_pt',isolationValue=0.12,antiIsoValue=0.2,lumi=19759.,bnr=0,btype='t',jnr=2,njetPt='20',jetPt='20',jetVeto=False,Control=True,Z_Region=False,Legacy=False,noMT=False,TT_m=False,TT_me=False,ST=False,Signal=False,Tomislav=False,extraCut='(2>1)',Ctl_Andrea=False):
 ...
 muon_selection = '(nrEle==0 && nrMu==1 && abs(muon_eta)<2.1 && muon_pt>30)'
 ...
 oneMUoneELE = '(nrEle==1 && nrMu==1 && abs(muon_eta)<2.1 && muon_pt>25)'
 ...
 jidType = 'idLoose'
 #jidType = 'idTight'
 puidType = 'fullIdLoosePu'
 #puidType = 'fullIdTight'
 #J1_PUID = '(J1_'+jidType+'Jet && J1_'+puidType+')' 
 #J2_PUID = '(J2_'+jidType+'Jet && J2_'+puidType+')' 
 #J3_PUID = '(J3_'+jidType+'Jet && J3_'+puidType+')' 
 #J4_PUID = '(J4_'+jidType+'Jet && J4_'+puidType+')' 
