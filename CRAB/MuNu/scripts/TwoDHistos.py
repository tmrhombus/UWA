...
for leafPair in leafs:
 ...
 if drawQCD:
  ###
  datanh,datanhSize,datanhSizePart,datanhEntries = make.hist2D(data_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsDatan,I,F)
  print('For QCD Shape')
  print('data nonIso')
 ...
 ####  Drell
  print('  z nonIso')
  znh,znhSize,znhSizePart,znhEntries = make.hist2D(z_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  znh.SetName('znh')
  znh.Scale(sf_drell)
  print('    '+str(znhSize))
 ...
 ####  Dibosons
  print('  ww nonIso')
  wwnh,wwnhSize,wwnhSizePart,wwnhEntries = make.hist2D(ww_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  wwnh.SetName('wwnh')
  wwnh.Scale(sf_vv)
  print('    '+str(wwnhSize))
  ...
  ###
  print('  wz nonIso')
  wznh,wznhSize,wznhSizePart,wznhEntries = make.hist2D(wz_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  wznh.SetName('wznh')
  wznh.Scale(sf_vv)
  print('    '+str(wznhSize))
  ...
  ###
  print('  ww nonIso')
  zznh,zznhSize,zznhSizePart,zznhEntries = make.hist2D(zz_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  zznh.SetName('zznh')
  zznh.Scale(sf_vv)
  print('    '+str(zznhSize))
 ...
 ####  Single Top
  print('  t t nonIso')
  t_tnh,t_tnhSize,t_tnhSizePart,t_tnhEntries = make.hist2D(t_t_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  t_tnh.SetName('t_tnh')
  t_tnh.Scale(sf_st_t)
  print('    '+str(t_tnhSize))
  ...
  ###
  print('  tb t nonIso')
  tb_tnh,tb_tnhSize,tb_tnhSizePart,tb_tnhEntries = make.hist2D(tb_t_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  ...
  ###
  print('  t s nonIso')
  t_snh,t_snhSize,t_snhSizePart,t_snhEntries = make.hist2D(t_s_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  t_snh.SetName('t_snh')
  t_snh.Scale(sf_st)
  print('    '+str(t_snhSize))
  ...
  ###
  print('  tb s nonIso')
  tb_snh,tb_snhSize,tb_snhSizePart,tb_snhEntries = make.hist2D(tb_s_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  ...
  ###
  print('  t tw nonIso')
  t_twnh,t_twnhSize,t_twnhSizePart,t_twnhEntries = make.hist2D(t_tw_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
  ...
  ###
  print('  tb tw nonIso')
  tb_twnh,tb_twnhSize,tb_twnhSizePart,tb_twnhEntries = make.hist2D(tb_tw_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCn,I,F)
 ...
 ####  TTbar
  ...
  tt_seminh,tt_seminhSize,tt_seminhSizePart,tt_seminhEntries = make.hist2D(tt_semi_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCnT,I,F)
  ...
  tt_fullnh,tt_fullnhSize,tt_fullnhSizePart,tt_fullnhEntries = make.hist2D(tt_full_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCnT,I,F)
 ...
 ####  W
  print('  wn nonIso')
  wnnh,wnnhSize,wnnhSizePart,wnhEntries = make.hist2D(wn_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCnW,I,F)
  wnnh.SetName('wnnh')
  wnnh.Scale(sf_wjets)
  print('    '+str(wnnhSize))
  ...
  print('  w1 nonIso')
  ###
  w1nh,w1nhSize,w1nhSizePart,w1nhEntries = make.hist2D(w1_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCnW,I,F)
  w1nh.SetName('w1nh')
  w1nh.Scale(sf_wjets)
  print('    '+str(w1nhSize))
  ...
  print('  w2 nonIso')
  ###
  w2nh,w2nhSize,w2nhSizePart,w2nhEntries = make.hist2D(w2_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCnW,I,F)
  w2nh.SetName('w2nh')
  w2nh.Scale(sf_wjets)
  print('    '+str(w2nhSize))
  ...
  print('  w3 nonIso')
  ###
  w3nh,w3nhSize,w3nhSizePart,w3nhEntries = make.hist2D(w3_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCnW,I,F)
  w3nh.SetName('w3nh')
  w3nh.Scale(sf_wjets)
  print('    '+str(w3nhSize))
  ...
  print('  w4 nonIso')
  ###
  w4nh,w4nhSize,w4nhSizePart,w4nhEntries = make.hist2D(w4_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCnW,I,F)
  w4nh.SetName('w4nh')
  w4nh.Scale(sf_wjets)
  print('    '+str(w4nhSize))
 ...
 if drawData:
  ...
  print("data Iso") 
  dataih,dataihSize,dataihSizePart,dataihEntries = make.hist2D(data_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsDatai,I,F)
...
#### Drell
 print("z Iso")
 zih,zihSize,zihSizePart,zihEntries = make.hist2D(z_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 zih.SetName('zih')
 zih.Scale(sf_drell)
 print('  '+str(zihSize))
...
#### Diboson
 print("ww Iso")
 wwih,wwihSize,wwihSizePart,wwihEntries = make.hist2D(ww_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 wwih.SetName('wwih')
 wwih.Scale(sf_vv)
 print('  '+str(wwihSize))
 ...
 ###
 print("wz Iso")
 wzih,wzihSize,wzihSizePart,wzihEntries = make.hist2D(wz_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 wzih.SetName('wzih')
 wzih.Scale(sf_vv)
 print('  '+str(wzihSize))
 ...
 ###
 print("zz Iso")
 zzih,zzihSize,zzihSizePart,zzihEntries = make.hist2D(zz_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 zzih.SetName('zzih')
 zzih.Scale(sf_vv)
 print('  '+str(zzihSize))
...
#### Single Top
 print('t t Iso')
 t_tih,t_tihSize,t_tihSizePart,t_tihEntries = make.hist2D(t_t_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 t_tih.SetName('t_tih')
 t_tih.Scale(sf_st_t)
 print('  '+str(t_tihSize))
 ...
 ###
 print('tb t Iso')
 tb_tih,tb_tihSize,tb_tihSizePart,tb_tihEntries = make.hist2D(tb_t_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 ...
 ###
 print('t s Iso')
 t_sih,t_sihSize,t_sihSizePart,t_sihEntries = make.hist2D(t_s_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 t_sih.SetName('t_sih')
 t_sih.Scale(sf_st)
 print('  '+str(t_sihSize))
 ...
 ###
 print('tb s Iso')
 tb_sih,tb_sihSize,tb_sihSizePart,tb_sihEntries = make.hist2D(tb_s_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 ...
 ###
 print('t tw Iso')
 t_twih,t_twihSize,t_twihSizePart,t_twihEntries = make.hist2D(t_tw_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
 ...
 ###
 print('tb tw Iso')
 tb_twih,tb_twihSize,tb_twihSizePart,tb_twihEntries = make.hist2D(tb_tw_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCi,I,F)
...
#### TTbar
 print('ttb semi Iso')
 tt_semiih,tt_semiihSize,tt_semiihSizePart,tt_semiihEntries = make.hist2D(tt_semi_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiT,I,F)
 ...
 ###
 print('ttb full Iso')
 tt_fullih,tt_fullihSize,tt_fullihSizePart,tt_fullihEntries = make.hist2D(tt_full_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiT,I,F)
...
#### W + Jets
 print('wl n Iso')
 wlnih,wlnihSize,wlnihSizePart,wlnihEntries = make.hist2D(wn_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwl,I,F)
 wlnih.SetName('wlnih')
 ...
 ####
 print('wc n Iso')
 wcnih,wcnihSize,wcnihSizePart,wcnihEntries = make.hist2D(wn_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwc,I,F)
 wcnih.SetName('wcnih')
 ...
 ####
 print('wcc n Iso')
 wccnih,wccnihSize,wccnihSizePart,wccnihEntries = make.hist2D(wn_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwcc,I,F)
 ...
 ####
 print('wbb n Iso')
 wbbnih,wbbnihSize,wbbnihSizePart,wbbnihEntries = make.hist2D(wn_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwbb,I,F)
...
#####
 print('wl 1 Iso')
 wl1ih,wl1ihSize,wl1ihSizePart,wl1ihEntries = make.hist2D(w1_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwl,I,F)
 wl1ih.SetName('wl1ih')
 ...
 ####
 print('wc 1 Iso')
 wc1ih,wc1ihSize,wc1ihSizePart,wc1ihEntries = make.hist2D(w1_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwc,I,F)
 wc1ih.SetName('wc1ih')
 ...
 ####
 print('wcc 1 Iso')
 wcc1ih,wcc1ihSize,wcc1ihSizePart,wcc1ihEntries = make.hist2D(w1_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwcc,I,F)
 ...
 ####
 print('wbb 1 Iso')
 wbb1ih,wbb1ihSize,wbb1ihSizePart,wbb1ihEntries = make.hist2D(w1_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwbb,I,F)
...
#####
 print('wl 2 Iso')
 wl2ih,wl2ihSize,wl2ihSizePart,wl2ihEntries = make.hist2D(w2_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwl,I,F)
 wl2ih.SetName('wl2ih')
 ...
 ####
 print('wc 2 Iso')
 wc2ih,wc2ihSize,wc2ihSizePart,wc2ihEntries = make.hist2D(w2_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwc,I,F)
 wc2ih.SetName('wc2ih')
 ...
 ####
 print('wcc 2 Iso')
 wcc2ih,wcc2ihSize,wcc2ihSizePart,wcc2ihEntries = make.hist2D(w2_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwcc,I,F)
 ...
 ####
 print('wbb 2 Iso')
 wbb2ih,wbb2ihSize,wbb2ihSizePart,wbb2ihEntries = make.hist2D(w2_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwbb,I,F)
...
#####
 print('wl 3 Iso')
 wl3ih,wl3ihSize,wl3ihSizePart,wl3ihEntries = make.hist2D(w3_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwl,I,F)
 wl3ih.SetName('wl3ih')
 ...
 ####
 print('wc 3 Iso')
 wc3ih,wc3ihSize,wc3ihSizePart,wc3ihEntries = make.hist2D(w3_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwc,I,F)
 wc3ih.SetName('wc3ih')
 ...
 ####
 print('wcc 3 Iso')
 wcc3ih,wcc3ihSize,wcc3ihSizePart,wcc3ihEntries = make.hist2D(w3_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwcc,I,F)
 ...
 ####
 print('wbb 3 Iso')
 wbb3ih,wbb3ihSize,wbb3ihSizePart,wbb3ihEntries = make.hist2D(w3_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwbb,I,F)
...
#####
 print('wl 4 Iso')
 wl4ih,wl4ihSize,wl4ihSizePart,wl4ihEntries = make.hist2D(w4_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwl,I,F)
 wl4ih.SetName('wl4ih')
 ...
 ####
 print('wc 4 Iso')
 wc4ih,wc4ihSize,wc4ihSizePart,wc4ihEntries = make.hist2D(w4_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwc,I,F)
 wc4ih.SetName('wc4ih')
 ...
 ####
 print('wcc 4 Iso')
 wcc4ih,wcc4ihSize,wcc4ihSizePart,wcc4ihEntries = make.hist2D(w4_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwcc,I,F)
 ...
 ####
 print('wbb 4 Iso')
 wbb4ih,wbb4ihSize,wbb4ihSizePart,wbb4ihEntries = make.hist2D(w4_tree,leafA,leafB,minA,maxA,stepsA,minB,maxB,stepsB,CutsMCiwbb,I,F)
