...
cat CONDOR_MC.py >> MuEle-PATMC_V7A.py
 ...
 #TTbar
 farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --resubmit-failed-jobs --vsize-limit=6000 \
...
#
# #ts
#farmoutAnalysisJobs $1 --input-files-per-job=1 --memory-requirements=8000 --resubmit-failed-jobs --vsize-limit=8000  \
