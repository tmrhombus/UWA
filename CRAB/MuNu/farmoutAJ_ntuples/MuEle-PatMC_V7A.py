...
#"file:/afs/hep.wisc.edu/cms/tperry/FSAv2_CMSSW_5_3_14/src/FinalStateAnalysis/Wbb4F_isItFull_001C0D8C-F40D-E211-9302-002590200814.root"
"root://cmsxrootd.hep.wisc.edu//store/user/tperry/WbbJetsToLNu_Massive_TuneZ2star_8TeV-madgraph-pythia6_tauola/Summer12_DR53X-PU_S10_START53_V7A-v1/AODSIM/Fall2014PATTuples_V1/patTuple_cfg-001C0D8C-F40D-E211-9302-002590200814.root", # "source"
...
defaultReconstructionPT(process,
 ...
 itsMC=True,itsData=False,lhep_=LHESource)
...
process.TFileService.fileName = cms.string('Wbb4F_skimmed_ntuple.root') 
