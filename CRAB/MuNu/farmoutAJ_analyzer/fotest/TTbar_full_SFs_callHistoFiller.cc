...
Usage: 
root -l -b
.L TTbar_full_SFs_callHistoFiller.cc
TTbar_full_SFs_callHistoFiller()

root -l -b -q TTbar_full_SFs_callHistoFiller.cc
...
void TTbar_full_SFs_callHistoFiller()
{
 int error = 0;
...
// TChain *theChainLESDown = new TChain("muEleEventTreeMuonDown/eventTree");
 ...
 TString outfileName =   "TTbar_full_SFs_callHistoFiller-MuEle-PATMC_V7A-patTuple_cfg-000560C1-FD97-E211-9F33-00304867924E.root";
 TString inputListName = "TTbar_full_SFs_callHistoFiller-MuEle-PATMC_V7A-patTuple_cfg-000560C1-FD97-E211-9F33-00304867924E.inputshdfs";
 ...
 TString sample="TTbar_full";
 UInt_t nrEvents = 10429331 ;
 Float_t crossSec = 25.1 ;
