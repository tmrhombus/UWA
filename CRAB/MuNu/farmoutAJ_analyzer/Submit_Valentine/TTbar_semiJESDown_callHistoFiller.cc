...
Usage: 
root -l -b
.L TTbar_semiJESDown_callHistoFiller.cc
TTbar_semiJESDown_callHistoFiller()

root -l -b -q TTbar_semiJESDown_callHistoFiller.cc
...
void TTbar_semiJESDown_callHistoFiller()
{
 int error = 0;
