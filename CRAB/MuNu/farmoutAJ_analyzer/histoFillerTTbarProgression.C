     ...
     )
{
 ...
 //std::cout<<"    entry "<<jentry<<std::endl;
  ...
  if( twoGoodLMuE && min2goodJs ){ // mu good
   if( btag1J ) { pass_ttme1b_mu_good=kTRUE; std::cout<<"pass 1b "<<std::endl;}
   if( btag2J ) { pass_ttme2b_mu_good=kTRUE; std::cout<<"pass 2b "<<std::endl;}
  ...
  if ( pass_ttme1b_mu_good ) { std::cout<<"Still passed 1b mu good"<< jentry<<std::endl; }
  // ttme1b
