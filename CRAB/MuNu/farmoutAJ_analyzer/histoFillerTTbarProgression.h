...
public :
   ...
   // Histograms
   std::vector<TString> PSpace;  // 8 ttme1b, ttme2b, ttme1bJv, ttme2bJv, ttme1bMt, ttme2bMt, ttme1bJvMt, ttme2bJvMt
   std::vector<TString> EMu;     // 2
   std::vector<TString> QCD;     // 2
   std::vector<TString> Syst;    // 7
   std::vector<TString> WFlav;   // 5
   TH1F hists_met[8][2][2][7][5];
   TH1F hists_met_phi[8][2][2][7][5];
   TH1F hists_mt[8][2][2][7][5];
   TH1F hists_goodLep_pt[8][2][2][7][5];
   TH1F hists_goodJ1_pt[8][2][2][7][5];
   TH1F hists_goodJ2_pt[8][2][2][7][5];
   TH1F hists_goodJ1J2_dR[8][2][2][7][5];
   TH1F hists_goodJ1J2_mass[8][2][2][7][5];
   TH1F hists_goodJ1J2_pt[8][2][2][7][5];
   TH1F hists_goodJ1_CSV[8][2][2][7][5];
   TH1F hists_goodJ1_mass_SV_unweighted[8][2][2][7][5];
   TH1F hists_goodJ1_mass_SV_corrected[8][2][2][7][5];
   TH1F hists_goodJ1_mass_SV_weighted[8][2][2][7][5];
   TH1F hists_goodJ2_CSV[8][2][2][7][5]; //
   TH1F hists_goodJ3J4_mass[8][2][2][7][5]; //
