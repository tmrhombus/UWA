...
Usage: 
root -l -b
.L TTbar_semi_LESDown_callHistoFiller.cc
TTbar_semi_LESDown_callHistoFiller()

root -l -b -q TTbar_semi_LESDown_callHistoFiller.cc
...
void TTbar_semi_LESDown_callHistoFiller()
{
 int error = 0;
