...
#addMuEleEventTreePtMC(process,'muNuEventTreeMuonUp',   lhep="externalLHEProducer")
#addMuEleEventTreePtMC(process,'muNuEventTreeMuonDown', lhep="externalLHEProducer")
#addMuEleEventTreePtMC(process,'muNuEventTreeJetUp',    lhep="externalLHEProducer")
#addMuEleEventTreePtMC(process,'muNuEventTreeJetDown',  lhep="externalLHEProducer")
...
process.TFileService.fileName = cms.string('noel_mc_new.root') 
