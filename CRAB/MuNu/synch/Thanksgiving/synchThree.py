...
print(       "http://www.hep.wisc.edu/~tperry/wbb/synch/ThanksgivingElectrons/%s%s_comp.log"%(cut,xn))
log = open('/afs/hep.wisc.edu/home/tperry/www/wbb/synch/ThanksgivingElectrons/%s%s_comp.log'%(cut,xn),'w')
