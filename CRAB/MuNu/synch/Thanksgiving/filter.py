...
#define the file
dir='/afs/hep.wisc.edu/cms/tperry/Wbb_CMSSW_5_3_14_patch1/src/UWAnalysis/CRAB/MuNu/synch/Thanksgiving/'
fname = "list.txt"
...
with open(fname) as f:
 for x in f:
  ...
  cut_str = "(HLT_Ele27_WP80_fired && nrGoodEle==1 && nrVetoEle<=1 && nrVetoMu==0 && nrGoodJets==2 && nrFwdJets==0)"
  #cut_str = "(HLT_Ele27_WP80_fired && nrGoodEle==1 && nrVetoEle<=1 && nrVetoMu==0 && nrGoodJets==2 && nrFwdJets==0 && mt_goodElectron>45)"
  #cut_str = "(HLT_Ele27_WP80_fired && nrGoodEle==1 && nrVetoEle<=1 && nrVetoMu==0 && nrGoodJets==2 && nrFwdJets==0 && mt_goodElectron>45 && goodJ1_CSV>0.898 && goodJ2_CSV>0.898)"
