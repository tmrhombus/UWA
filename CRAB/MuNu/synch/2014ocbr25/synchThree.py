cut = "C1_tt_2014ocbr28_maybeFinal"
xn = ""
...
toms_events    = set([line.strip() for line in open('./comp/%s%s_tom.txt'%(cut,xn))])
...
print(       "http://www.hep.wisc.edu/~tperry/wbb/synch/2014ocbr25/%s%s_comp.log"%(cut,xn))
log = open('/afs/hep.wisc.edu/home/tperry/www/wbb/synch/2014ocbr25/%s%s_comp.log'%(cut,xn),'w')
