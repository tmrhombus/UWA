...
#TTbar
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_TTbar_full $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_TTbar_semi $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_WJets_p1 $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_WJets_p2 $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_W1Jet_p1 $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_W1Jet_p2 $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_W2Jet_p1 $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_W2Jet_p2 $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_W3Jet_p1 $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_W3Jet_p2 $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_W4Jet $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1  --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  ...
  ${version}_Wbb4F $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_Drell $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_Tbar_tW $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_T_tW $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_T_t $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
 ...
 ${version}_Tbar_t $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_T_s $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_Tbar_s $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_WW $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_WZ $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
farmoutAnalysisJobs $1 --input-files-per-job=1 \
  ...
  ${version}_ZZ $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/MuEle-PATMC.py
...
# muons
farmoutAnalysisJobs --input-files-per-job=1 --shared-fs --memory-requirements=6000 --vsize-limit=6000 --use-osg  --resubmit-failed-jobs \
  --input-dir=root://cmsxrootd.hep.wisc.edu//store/user/tperry/SingleMu/Run2012A-22Jan2013-v1/AOD/Spring2014PATTuples_v3/ \
  ${version}_DataA_8TeVMu $CMSSW_BASE $CMSSW_BASE/src/UWAnalysis/CRAB/MuNu/farmoutAJ_ntuples/Mu-PATData.py
