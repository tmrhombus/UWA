...
// Tue May 19 08:43:07 2015 by ROOT version 5.32/00
// from TTree eventTree/
// found on file: /hdfs/store/user/tperry/Dercury_DataA_8TeVEle-Ele-PATData/Ele-PATData-skimpattuple_cfg-patTuple_cfg-04B19110-CA72-E211-8EBB-002481E0DA4E.root
//////////////////////////////////////////////////////////
...
#ifdef Q_class_cxx
Q_class::Q_class(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/tperry/Dercury_DataA_8TeVEle-Ele-PATData/Ele-PATData-skimpattuple_cfg-patTuple_cfg-04B19110-CA72-E211-8EBB-002481E0DA4E.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/tperry/Dercury_DataA_8TeVEle-Ele-PATData/Ele-PATData-skimpattuple_cfg-patTuple_cfg-04B19110-CA72-E211-8EBB-002481E0DA4E.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/tperry/Dercury_DataA_8TeVEle-Ele-PATData/Ele-PATData-skimpattuple_cfg-patTuple_cfg-04B19110-CA72-E211-8EBB-002481E0DA4E.root:/electronEventTree");
...
Int_t Q_class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Q_class::LoadTree(Long64_t entry)
{
...
void Q_class::Show(Long64_t entry)
{
...
Int_t Q_class::Cut(Long64_t entry)
{
