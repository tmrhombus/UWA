...
Usage: 
root -l -b
.L DataA_8TeVEle_callHistoFillerTTbarProgression.cc
DataA_8TeVEle_callHistoFillerTTbarProgression()

root -l -b -q DataA_8TeVEle_callHistoFillerTTbarProgression.cc
...
void DataA_8TeVEle_callHistoFillerTTbarProgression()
{
 int error = 0;
