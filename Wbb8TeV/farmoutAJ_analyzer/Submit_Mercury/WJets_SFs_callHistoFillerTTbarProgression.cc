...
Usage: 
root -l -b
.L WJets_SFs_callHistoFillerTTbarProgression.cc
WJets_SFs_callHistoFillerTTbarProgression()

root -l -b -q WJets_SFs_callHistoFillerTTbarProgression.cc
...
void WJets_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
