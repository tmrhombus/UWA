...
Usage: 
root -l -b
.L W2Jet_SFs_callHistoFillerTTbarProgression.cc
W2Jet_SFs_callHistoFillerTTbarProgression()

root -l -b -q W2Jet_SFs_callHistoFillerTTbarProgression.cc
...
void W2Jet_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
