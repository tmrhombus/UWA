...
Usage: 
root -l -b
.L W2Jet_JESUp_callHistoFillerTTbarProgression.cc
W2Jet_JESUp_callHistoFillerTTbarProgression()

root -l -b -q W2Jet_JESUp_callHistoFillerTTbarProgression.cc
...
void W2Jet_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
