...
Usage: 
root -l -b
.L DataB_8TeVEle_callHistoFillerTTbarProgression.cc
DataB_8TeVEle_callHistoFillerTTbarProgression()

root -l -b -q DataB_8TeVEle_callHistoFillerTTbarProgression.cc
...
void DataB_8TeVEle_callHistoFillerTTbarProgression()
{
 int error = 0;
