...
Usage: 
root -l -b
.L Tbar_s_JESDown_callHistoFillerTTbarProgression.cc
Tbar_s_JESDown_callHistoFillerTTbarProgression()

root -l -b -q Tbar_s_JESDown_callHistoFillerTTbarProgression.cc
...
void Tbar_s_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
