...
Usage: 
root -l -b
.L WJets_JESUp_callHistoFillerTTbarProgression.cc
WJets_JESUp_callHistoFillerTTbarProgression()

root -l -b -q WJets_JESUp_callHistoFillerTTbarProgression.cc
...
void WJets_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
