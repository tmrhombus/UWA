...
Usage: 
root -l -b
.L Tbar_s_SFs_callHistoFillerTTbarProgression.cc
Tbar_s_SFs_callHistoFillerTTbarProgression()

root -l -b -q Tbar_s_SFs_callHistoFillerTTbarProgression.cc
...
void Tbar_s_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
