...
Usage: 
root -l -b
.L WW_SFs_callHistoFillerTTbarProgression.cc
WW_SFs_callHistoFillerTTbarProgression()

root -l -b -q WW_SFs_callHistoFillerTTbarProgression.cc
...
void WW_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
