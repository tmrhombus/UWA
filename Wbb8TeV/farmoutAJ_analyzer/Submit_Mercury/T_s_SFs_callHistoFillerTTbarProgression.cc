...
Usage: 
root -l -b
.L T_s_SFs_callHistoFillerTTbarProgression.cc
T_s_SFs_callHistoFillerTTbarProgression()

root -l -b -q T_s_SFs_callHistoFillerTTbarProgression.cc
...
void T_s_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
