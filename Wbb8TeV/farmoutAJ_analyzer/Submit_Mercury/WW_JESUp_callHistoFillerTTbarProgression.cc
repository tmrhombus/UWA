...
Usage: 
root -l -b
.L WW_JESUp_callHistoFillerTTbarProgression.cc
WW_JESUp_callHistoFillerTTbarProgression()

root -l -b -q WW_JESUp_callHistoFillerTTbarProgression.cc
...
void WW_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
