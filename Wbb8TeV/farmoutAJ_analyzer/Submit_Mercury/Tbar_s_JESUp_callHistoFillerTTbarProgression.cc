...
Usage: 
root -l -b
.L Tbar_s_JESUp_callHistoFillerTTbarProgression.cc
Tbar_s_JESUp_callHistoFillerTTbarProgression()

root -l -b -q Tbar_s_JESUp_callHistoFillerTTbarProgression.cc
...
void Tbar_s_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
