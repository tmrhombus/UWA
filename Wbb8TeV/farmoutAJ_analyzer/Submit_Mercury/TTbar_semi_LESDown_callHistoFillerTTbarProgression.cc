...
Usage: 
root -l -b
.L TTbar_semi_LESDown_callHistoFillerTTbarProgression.cc
TTbar_semi_LESDown_callHistoFillerTTbarProgression()

root -l -b -q TTbar_semi_LESDown_callHistoFillerTTbarProgression.cc
...
void TTbar_semi_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
