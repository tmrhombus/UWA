...
Usage: 
root -l -b
.L DataD_8TeVMu_callHistoFillerTTbarProgression.cc
DataD_8TeVMu_callHistoFillerTTbarProgression()

root -l -b -q DataD_8TeVMu_callHistoFillerTTbarProgression.cc
...
void DataD_8TeVMu_callHistoFillerTTbarProgression()
{
 int error = 0;
