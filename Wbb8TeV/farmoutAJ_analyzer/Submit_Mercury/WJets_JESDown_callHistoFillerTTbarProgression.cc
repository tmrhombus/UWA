...
Usage: 
root -l -b
.L WJets_JESDown_callHistoFillerTTbarProgression.cc
WJets_JESDown_callHistoFillerTTbarProgression()

root -l -b -q WJets_JESDown_callHistoFillerTTbarProgression.cc
...
void WJets_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
