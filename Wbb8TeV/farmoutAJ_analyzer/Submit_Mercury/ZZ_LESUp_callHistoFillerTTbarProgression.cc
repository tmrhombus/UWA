...
Usage: 
root -l -b
.L ZZ_LESUp_callHistoFillerTTbarProgression.cc
ZZ_LESUp_callHistoFillerTTbarProgression()

root -l -b -q ZZ_LESUp_callHistoFillerTTbarProgression.cc
...
void ZZ_LESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
