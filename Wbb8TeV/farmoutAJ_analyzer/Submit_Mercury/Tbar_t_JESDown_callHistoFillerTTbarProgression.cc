...
Usage: 
root -l -b
.L Tbar_t_JESDown_callHistoFillerTTbarProgression.cc
Tbar_t_JESDown_callHistoFillerTTbarProgression()

root -l -b -q Tbar_t_JESDown_callHistoFillerTTbarProgression.cc
...
void Tbar_t_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
