...
Usage: 
root -l -b
.L Wbb4F_SFs_callHistoFillerTTbarProgression.cc
Wbb4F_SFs_callHistoFillerTTbarProgression()

root -l -b -q Wbb4F_SFs_callHistoFillerTTbarProgression.cc
...
void Wbb4F_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
