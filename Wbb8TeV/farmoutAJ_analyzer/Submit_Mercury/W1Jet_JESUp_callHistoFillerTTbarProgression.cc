...
Usage: 
root -l -b
.L W1Jet_JESUp_callHistoFillerTTbarProgression.cc
W1Jet_JESUp_callHistoFillerTTbarProgression()

root -l -b -q W1Jet_JESUp_callHistoFillerTTbarProgression.cc
...
void W1Jet_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
