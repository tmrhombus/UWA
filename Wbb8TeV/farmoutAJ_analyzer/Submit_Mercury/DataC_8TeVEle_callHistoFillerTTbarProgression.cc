...
Usage: 
root -l -b
.L DataC_8TeVEle_callHistoFillerTTbarProgression.cc
DataC_8TeVEle_callHistoFillerTTbarProgression()

root -l -b -q DataC_8TeVEle_callHistoFillerTTbarProgression.cc
...
void DataC_8TeVEle_callHistoFillerTTbarProgression()
{
 int error = 0;
