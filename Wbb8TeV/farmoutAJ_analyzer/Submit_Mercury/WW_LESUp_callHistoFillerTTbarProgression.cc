...
Usage: 
root -l -b
.L WW_LESUp_callHistoFillerTTbarProgression.cc
WW_LESUp_callHistoFillerTTbarProgression()

root -l -b -q WW_LESUp_callHistoFillerTTbarProgression.cc
...
void WW_LESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
