...
Usage: 
root -l -b
.L Tbar_tW_SFs_callHistoFillerTTbarProgression.cc
Tbar_tW_SFs_callHistoFillerTTbarProgression()

root -l -b -q Tbar_tW_SFs_callHistoFillerTTbarProgression.cc
...
void Tbar_tW_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
