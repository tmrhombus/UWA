...
Usage: 
root -l -b
.L WZ_JESDown_callHistoFillerTTbarProgression.cc
WZ_JESDown_callHistoFillerTTbarProgression()

root -l -b -q WZ_JESDown_callHistoFillerTTbarProgression.cc
...
void WZ_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
