...
Usage: 
root -l -b
.L W2Jet_LESUp_callHistoFillerTTbarProgression.cc
W2Jet_LESUp_callHistoFillerTTbarProgression()

root -l -b -q W2Jet_LESUp_callHistoFillerTTbarProgression.cc
...
void W2Jet_LESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
