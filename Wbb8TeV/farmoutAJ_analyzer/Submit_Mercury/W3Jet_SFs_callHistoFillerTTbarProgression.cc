...
Usage: 
root -l -b
.L W3Jet_SFs_callHistoFillerTTbarProgression.cc
W3Jet_SFs_callHistoFillerTTbarProgression()

root -l -b -q W3Jet_SFs_callHistoFillerTTbarProgression.cc
...
void W3Jet_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
