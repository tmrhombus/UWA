...
Usage: 
root -l -b
.L W1Jet_JESDown_callHistoFillerTTbarProgression.cc
W1Jet_JESDown_callHistoFillerTTbarProgression()

root -l -b -q W1Jet_JESDown_callHistoFillerTTbarProgression.cc
...
void W1Jet_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
