...
Usage: 
root -l -b
.L WW_JESDown_callHistoFillerTTbarProgression.cc
WW_JESDown_callHistoFillerTTbarProgression()

root -l -b -q WW_JESDown_callHistoFillerTTbarProgression.cc
...
void WW_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
