...
Usage: 
root -l -b
.L T_s_JESDown_callHistoFillerTTbarProgression.cc
T_s_JESDown_callHistoFillerTTbarProgression()

root -l -b -q T_s_JESDown_callHistoFillerTTbarProgression.cc
...
void T_s_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
