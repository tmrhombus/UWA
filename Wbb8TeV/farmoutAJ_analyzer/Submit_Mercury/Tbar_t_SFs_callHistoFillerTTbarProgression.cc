...
Usage: 
root -l -b
.L Tbar_t_SFs_callHistoFillerTTbarProgression.cc
Tbar_t_SFs_callHistoFillerTTbarProgression()

root -l -b -q Tbar_t_SFs_callHistoFillerTTbarProgression.cc
...
void Tbar_t_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
