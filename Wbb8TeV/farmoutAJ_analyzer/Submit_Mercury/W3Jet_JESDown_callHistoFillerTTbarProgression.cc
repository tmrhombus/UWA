...
Usage: 
root -l -b
.L W3Jet_JESDown_callHistoFillerTTbarProgression.cc
W3Jet_JESDown_callHistoFillerTTbarProgression()

root -l -b -q W3Jet_JESDown_callHistoFillerTTbarProgression.cc
...
void W3Jet_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
