...
Usage: 
root -l -b
.L Drell_JESDown_callHistoFillerTTbarProgression.cc
Drell_JESDown_callHistoFillerTTbarProgression()

root -l -b -q Drell_JESDown_callHistoFillerTTbarProgression.cc
...
void Drell_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
