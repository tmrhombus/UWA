...
Usage: 
root -l -b
.L Wbb4F_JESDown_callHistoFillerTTbarProgression.cc
Wbb4F_JESDown_callHistoFillerTTbarProgression()

root -l -b -q Wbb4F_JESDown_callHistoFillerTTbarProgression.cc
...
void Wbb4F_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
