...
Usage: 
root -l -b
.L ZZ_LESDown_callHistoFillerTTbarProgression.cc
ZZ_LESDown_callHistoFillerTTbarProgression()

root -l -b -q ZZ_LESDown_callHistoFillerTTbarProgression.cc
...
void ZZ_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
