...
Usage: 
root -l -b
.L W1Jet_SFs_callHistoFillerTTbarProgression.cc
W1Jet_SFs_callHistoFillerTTbarProgression()

root -l -b -q W1Jet_SFs_callHistoFillerTTbarProgression.cc
...
void W1Jet_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
