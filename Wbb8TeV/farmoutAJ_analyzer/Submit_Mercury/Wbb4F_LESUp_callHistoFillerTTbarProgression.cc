...
Usage: 
root -l -b
.L Wbb4F_LESUp_callHistoFillerTTbarProgression.cc
Wbb4F_LESUp_callHistoFillerTTbarProgression()

root -l -b -q Wbb4F_LESUp_callHistoFillerTTbarProgression.cc
...
void Wbb4F_LESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
