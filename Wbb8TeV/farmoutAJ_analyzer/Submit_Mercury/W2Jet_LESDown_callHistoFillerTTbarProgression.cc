...
Usage: 
root -l -b
.L W2Jet_LESDown_callHistoFillerTTbarProgression.cc
W2Jet_LESDown_callHistoFillerTTbarProgression()

root -l -b -q W2Jet_LESDown_callHistoFillerTTbarProgression.cc
...
void W2Jet_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
