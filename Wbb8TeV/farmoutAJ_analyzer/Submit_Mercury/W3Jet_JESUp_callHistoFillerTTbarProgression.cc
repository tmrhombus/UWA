...
Usage: 
root -l -b
.L W3Jet_JESUp_callHistoFillerTTbarProgression.cc
W3Jet_JESUp_callHistoFillerTTbarProgression()

root -l -b -q W3Jet_JESUp_callHistoFillerTTbarProgression.cc
...
void W3Jet_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
