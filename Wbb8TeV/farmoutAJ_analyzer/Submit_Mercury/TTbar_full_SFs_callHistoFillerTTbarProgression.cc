...
Usage: 
root -l -b
.L TTbar_full_SFs_callHistoFillerTTbarProgression.cc
TTbar_full_SFs_callHistoFillerTTbarProgression()

root -l -b -q TTbar_full_SFs_callHistoFillerTTbarProgression.cc
...
void TTbar_full_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
