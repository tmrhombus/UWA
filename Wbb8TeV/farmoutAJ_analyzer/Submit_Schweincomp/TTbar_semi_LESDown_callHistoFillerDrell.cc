...
Usage: 
root -l -b
.L TTbar_semi_LESDown_callHistoFillerDrell.cc
TTbar_semi_LESDown_callHistoFillerDrell()

root -l -b -q TTbar_semi_LESDown_callHistoFillerDrell.cc
...
void TTbar_semi_LESDown_callHistoFillerDrell()
{
 int error = 0;
