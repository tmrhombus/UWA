...
Usage: 
root -l -b
.L WJets_LESUp_callHistoFillerDrell.cc
WJets_LESUp_callHistoFillerDrell()

root -l -b -q WJets_LESUp_callHistoFillerDrell.cc
...
void WJets_LESUp_callHistoFillerDrell()
{
 int error = 0;
