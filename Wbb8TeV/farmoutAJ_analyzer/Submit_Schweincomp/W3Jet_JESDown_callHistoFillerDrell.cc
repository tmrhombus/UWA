...
Usage: 
root -l -b
.L W3Jet_JESDown_callHistoFillerDrell.cc
W3Jet_JESDown_callHistoFillerDrell()

root -l -b -q W3Jet_JESDown_callHistoFillerDrell.cc
...
void W3Jet_JESDown_callHistoFillerDrell()
{
 int error = 0;
