...
Usage: 
root -l -b
.L DataB_8TeVMu_callHistoFillerDrell.cc
DataB_8TeVMu_callHistoFillerDrell()

root -l -b -q DataB_8TeVMu_callHistoFillerDrell.cc
...
void DataB_8TeVMu_callHistoFillerDrell()
{
 int error = 0;
