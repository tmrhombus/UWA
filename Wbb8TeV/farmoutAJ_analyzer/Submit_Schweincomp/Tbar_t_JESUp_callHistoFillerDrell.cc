...
Usage: 
root -l -b
.L Tbar_t_JESUp_callHistoFillerDrell.cc
Tbar_t_JESUp_callHistoFillerDrell()

root -l -b -q Tbar_t_JESUp_callHistoFillerDrell.cc
...
void Tbar_t_JESUp_callHistoFillerDrell()
{
 int error = 0;
