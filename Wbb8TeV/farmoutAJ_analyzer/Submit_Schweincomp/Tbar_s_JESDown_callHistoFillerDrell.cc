...
Usage: 
root -l -b
.L Tbar_s_JESDown_callHistoFillerDrell.cc
Tbar_s_JESDown_callHistoFillerDrell()

root -l -b -q Tbar_s_JESDown_callHistoFillerDrell.cc
...
void Tbar_s_JESDown_callHistoFillerDrell()
{
 int error = 0;
