...
Usage: 
root -l -b
.L DataA_8TeVMu_callHistoFillerDrell.cc
DataA_8TeVMu_callHistoFillerDrell()

root -l -b -q DataA_8TeVMu_callHistoFillerDrell.cc
...
void DataA_8TeVMu_callHistoFillerDrell()
{
 int error = 0;
