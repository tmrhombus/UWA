...
Usage: 
root -l -b
.L DataA_8TeVEle_callHistoFillerDrell.cc
DataA_8TeVEle_callHistoFillerDrell()

root -l -b -q DataA_8TeVEle_callHistoFillerDrell.cc
...
void DataA_8TeVEle_callHistoFillerDrell()
{
 int error = 0;
