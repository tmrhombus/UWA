...
Usage: 
root -l -b
.L DataC_8TeVEle_callHistoFillerDrell.cc
DataC_8TeVEle_callHistoFillerDrell()

root -l -b -q DataC_8TeVEle_callHistoFillerDrell.cc
...
void DataC_8TeVEle_callHistoFillerDrell()
{
 int error = 0;
