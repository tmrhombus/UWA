...
Usage: 
root -l -b
.L WJets_JESUp_callHistoFillerDrell.cc
WJets_JESUp_callHistoFillerDrell()

root -l -b -q WJets_JESUp_callHistoFillerDrell.cc
...
void WJets_JESUp_callHistoFillerDrell()
{
 int error = 0;
