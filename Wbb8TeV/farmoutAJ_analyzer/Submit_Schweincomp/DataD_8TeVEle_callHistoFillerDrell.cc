...
Usage: 
root -l -b
.L DataD_8TeVEle_callHistoFillerDrell.cc
DataD_8TeVEle_callHistoFillerDrell()

root -l -b -q DataD_8TeVEle_callHistoFillerDrell.cc
...
void DataD_8TeVEle_callHistoFillerDrell()
{
 int error = 0;
