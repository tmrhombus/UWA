...
Usage: 
root -l -b
.L W2Jet_LESUp_callHistoFillerDrell.cc
W2Jet_LESUp_callHistoFillerDrell()

root -l -b -q W2Jet_LESUp_callHistoFillerDrell.cc
...
void W2Jet_LESUp_callHistoFillerDrell()
{
 int error = 0;
