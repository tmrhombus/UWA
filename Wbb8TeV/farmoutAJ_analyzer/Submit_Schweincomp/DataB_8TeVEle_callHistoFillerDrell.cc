...
Usage: 
root -l -b
.L DataB_8TeVEle_callHistoFillerDrell.cc
DataB_8TeVEle_callHistoFillerDrell()

root -l -b -q DataB_8TeVEle_callHistoFillerDrell.cc
...
void DataB_8TeVEle_callHistoFillerDrell()
{
 int error = 0;
