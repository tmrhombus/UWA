...
Usage: 
root -l -b
.L WJets_JESDown_callHistoFillerDrell.cc
WJets_JESDown_callHistoFillerDrell()

root -l -b -q WJets_JESDown_callHistoFillerDrell.cc
...
void WJets_JESDown_callHistoFillerDrell()
{
 int error = 0;
