#ifndef histoFillerDrell_h
#define histoFillerDrell_h
...
public :
   ...
   TH1F hists_met[14][2][1][3][5];
   TH1F hists_met_phi[14][2][1][3][5];
   TH1F hists_mt[14][2][1][3][5];

   TH1F hists_goodLep_pt[14][2][1][3][5];                            //
   TH1F hists_goodLep_eta[14][2][1][3][5];                           //
   TH1F hists_goodLep_phi[14][2][1][3][5];                           //
   TH1F hists_goodLep_mass[14][2][1][3][5];                          //
                                                                    //
   TH1F hists_goodJ1_pt[14][2][1][3][5];                             //
   TH1F hists_goodJ1_eta[14][2][1][3][5];                            //
   TH1F hists_goodJ1_phi[14][2][1][3][5];                            //
   TH1F hists_goodJ1_mass[14][2][1][3][5];                           //
   TH1F hists_goodJ1_CSV[14][2][1][3][5];                            //
   TH1F hists_goodJ1_mass_SV_unweighted[14][2][1][3][5];             //
   TH1F hists_goodJ1_mass_SV_corrected[14][2][1][3][5];              //
   TH1F hists_goodJ1_mass_SV_weighted[14][2][1][3][5];               //
                                                                    //
   TH1F hists_goodJ2_pt[14][2][1][3][5];                             //
   TH1F hists_goodJ2_eta[14][2][1][3][5];                            //
   TH1F hists_goodJ2_phi[14][2][1][3][5];                            //
   TH1F hists_goodJ2_mass[14][2][1][3][5];                           //
   TH1F hists_goodJ2_CSV[14][2][1][3][5];                            //
                                                                    //
   TH1F hists_goodJ3_pt[14][2][1][3][5];                             //
   TH1F hists_goodJ3_eta[14][2][1][3][5];                            //
   TH1F hists_goodJ3_phi[14][2][1][3][5];                            //
   TH1F hists_goodJ3_mass[14][2][1][3][5];                           //
   TH1F hists_goodJ3_CSV[14][2][1][3][5];                            //
                                                                    //
   TH1F hists_goodJ4_pt[14][2][1][3][5];                             //
   TH1F hists_goodJ4_eta[14][2][1][3][5];                            //
   TH1F hists_goodJ4_phi[14][2][1][3][5];                            //
   TH1F hists_goodJ4_mass[14][2][1][3][5];                           //
   TH1F hists_goodJ4_CSV[14][2][1][3][5];                            //
                                                                    //
   TH1F hists_goodJ1J2_dR[14][2][1][3][5];                           //
   TH1F hists_goodJ1J2_pt[14][2][1][3][5];                           //
   TH1F hists_goodJ1J2_eta[14][2][1][3][5];                          //
   TH1F hists_goodJ1J2_phi[14][2][1][3][5];                          //
   TH1F hists_goodJ1J2_mass[14][2][1][3][5];                         //
                                                                    //
   TH1F hists_goodJ3J4_pt[14][2][1][3][5];                           //
   TH1F hists_goodJ3J4_eta[14][2][1][3][5];                          //
   TH1F hists_goodJ3J4_phi[14][2][1][3][5];                          //
   TH1F hists_goodJ3J4_mass[14][2][1][3][5];                         //
                                                                    //
   TH1F hists_goodL1L2_mass[14][2][1][3][5];                         //
   TH1F hists_goodL1L2_pt[14][2][1][3][5];                           //
   TH1F hists_goodL1L2_eta[14][2][1][3][5];                          //
   TH1F hists_goodL1L2_phi[14][2][1][3][5];                          //
   ...
   Float_t SF_tB1 ;
   Float_t SF_tB2 ;
   Float_t SF_mB1_errUp ;
   Float_t SF_mB2_errUp ;
   Float_t SF_tB1_errUp ;
   Float_t SF_tB2_errUp ;
   Float_t SF_mB1_errDn ;
   Float_t SF_mB2_errDn ;
   Float_t SF_tB1_errDn ;
   Float_t SF_tB2_errDn ;

   // event weights
   Float_t weight_mu ;
   Float_t weight_mB1_mu;
   Float_t weight_tB1_mu;
   Float_t weight_mB2_mu;
   Float_t weight_tB2_mu;
   Float_t weight_mB1_CSVUp_mu ;
   Float_t weight_tB1_CSVUp_mu ;
   Float_t weight_mB2_CSVUp_mu ;
   Float_t weight_tB2_CSVUp_mu ;
   Float_t weight_mB1_CSVDown_mu ;
   Float_t weight_tB1_CSVDown_mu ;
   Float_t weight_mB2_CSVDown_mu ;
   Float_t weight_tB2_CSVDown_mu ;
   Float_t weight_ele ;
   Float_t weight_mB1_ele ;
   Float_t weight_tB1_ele ;
   Float_t weight_mB2_ele ;
   Float_t weight_tB2_ele ;
   Float_t weight_mB1_CSVUp_ele ;
   Float_t weight_tB1_CSVUp_ele ;
   Float_t weight_mB2_CSVUp_ele ;
   Float_t weight_tB2_CSVUp_ele ;
   Float_t weight_mB1_CSVDown_ele ;
   Float_t weight_tB1_CSVDown_ele ;
   Float_t weight_mB2_CSVDown_ele ;
   Float_t weight_tB2_CSVDown_ele ;
   ...
   Bool_t pass_g2CJ_mu;
   Bool_t pass_e2CJ_mu;
   Bool_t pass_g2CJ_mB1_mu;
   Bool_t pass_g2CJ_tB1_mu;
   Bool_t pass_g2CJ_mB2_mu;
   Bool_t pass_g2CJ_tB2_mu;
   Bool_t pass_g2CJ_xFJ_mu;
   Bool_t pass_e2CJ_xFJ_mu;
   Bool_t pass_e2CJ_xFJ_mB1_mu;
   Bool_t pass_e2CJ_xFJ_tB1_mu;
   Bool_t pass_e2CJ_xFJ_mB2_mu;
   Bool_t pass_e2CJ_xFJ_tB2_mu;
   Bool_t pass_g0CJ_ele;
   Bool_t pass_g1CJ_ele;
   Bool_t pass_g2CJ_ele;
   Bool_t pass_e2CJ_ele;
   Bool_t pass_g2CJ_mB1_ele;
   Bool_t pass_g2CJ_tB1_ele;
   Bool_t pass_g2CJ_mB2_ele;
   Bool_t pass_g2CJ_tB2_ele;
   Bool_t pass_g2CJ_xFJ_ele;
   Bool_t pass_e2CJ_xFJ_ele;
   Bool_t pass_e2CJ_xFJ_mB1_ele;
   Bool_t pass_e2CJ_xFJ_tB1_ele;
   Bool_t pass_e2CJ_xFJ_mB2_ele;
   Bool_t pass_e2CJ_xFJ_tB2_ele;
...
////   Float_t         vetoMu_pt;
   ...
   histoFillerDrell(TTree *tree=0, Bool_t isMC=kTRUE);
   virtual ~histoFillerDrell();
...
#ifdef histoFillerDrell_cxx
histoFillerDrell::histoFillerDrell(TTree *tree, Bool_t isMC) : fChain(0) 
{
...
histoFillerDrell::~histoFillerDrell()
{
   if (!fChain) return;
...
Int_t histoFillerDrell::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t histoFillerDrell::LoadTree(Long64_t entry)
{
...
void histoFillerDrell::Init(TTree *tree, Bool_t isMC)
{
   ...
   Syst.clear();
   WFlav.clear();
   PSpace.push_back("g0CJ");
   PSpace.push_back("g1CJ");
   PSpace.push_back("g2CJ");
   PSpace.push_back("e2CJ");
   PSpace.push_back("g2CJ_mB1");
   PSpace.push_back("g2CJ_tB1");
   PSpace.push_back("g2CJ_mB2");
   PSpace.push_back("g2CJ_tB2");
   PSpace.push_back("g2CJ_xFJ");
   PSpace.push_back("e2CJ_xFJ");
   PSpace.push_back("e2CJ_xFJ_mB1");
   PSpace.push_back("e2CJ_xFJ_tB1");
   PSpace.push_back("e2CJ_xFJ_mB2");
   PSpace.push_back("e2CJ_xFJ_tB2");
   EMu.push_back("mu");
   EMu.push_back("ele");
   QCD.push_back("good");
   Syst.push_back("");
...
Bool_t histoFillerDrell::Notify()
{
...
void histoFillerDrell::Show(Long64_t entry)
{
...
double histoFillerDrell::dPhi(double phi1, double phi2){
 double dphi;
...
double histoFillerDrell::dEta(double eta1, double eta2){
 double deta;
 deta = std::abs(eta1-eta2);
 return deta;
}

Bool_t histoFillerDrell::FillHistograms(
  int i, int j, int k, int l, int m, 
  double metval, double metphival, double mt, 
  double lep_pt, double lep_eta, double lep_phi, double lep_mass,
  double dilep_pt, double dilep_eta, double dilep_phi, double dilep_mass,
...
Bool_t histoFillerDrell::WriteHistograms(int i, int j, int k, int l, int m){
...
Bool_t histoFillerDrell::DeleteHistograms(int i, int j, int k, int l, int m){
...
Bool_t histoFillerDrell::fillHistWriter(
...
Bool_t histoFillerDrell::writeHistWriter( int pspace_nr, int syst_nr, Bool_t isW ){
...
#endif // #ifdef histoFillerDrell_cxx
