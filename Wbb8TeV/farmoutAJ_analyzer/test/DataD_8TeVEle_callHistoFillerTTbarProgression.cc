...
Usage: 
root -l -b
.L DataD_8TeVEle_callHistoFillerTTbarProgression.cc
DataD_8TeVEle_callHistoFillerTTbarProgression()

root -l -b -q DataD_8TeVEle_callHistoFillerTTbarProgression.cc
...
void DataD_8TeVEle_callHistoFillerTTbarProgression()
{
 int error = 0;
...
// TChain *theChainLESDown = new TChain("muEleEventTreeMuonDown/eventTree");
 ...
 TString outfileName = "TT_DataDEle.root";
