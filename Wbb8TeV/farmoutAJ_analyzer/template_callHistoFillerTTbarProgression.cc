...
Usage: 
root -l -b
.L PSANDSHIFT_callHistoFillerTTbarProgression.cc
PSANDSHIFT_callHistoFillerTTbarProgression()

root -l -b -q PSANDSHIFT_callHistoFillerTTbarProgression.cc
...
void PSANDSHIFT_callHistoFillerTTbarProgression()
{
 int error = 0;
