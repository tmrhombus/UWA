...
Usage: 
root -l -b
.L WJets_LESDown_callHistoFillerTTbarProgression.cc
WJets_LESDown_callHistoFillerTTbarProgression()

root -l -b -q WJets_LESDown_callHistoFillerTTbarProgression.cc
...
void WJets_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
