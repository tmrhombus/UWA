...
Usage: 
root -l -b
.L DataB_8TeVMu_callHistoFillerTTbarProgression.cc
DataB_8TeVMu_callHistoFillerTTbarProgression()

root -l -b -q DataB_8TeVMu_callHistoFillerTTbarProgression.cc
...
void DataB_8TeVMu_callHistoFillerTTbarProgression()
{
 int error = 0;
