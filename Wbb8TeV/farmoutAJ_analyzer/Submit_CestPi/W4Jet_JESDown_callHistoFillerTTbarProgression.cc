...
Usage: 
root -l -b
.L W4Jet_JESDown_callHistoFillerTTbarProgression.cc
W4Jet_JESDown_callHistoFillerTTbarProgression()

root -l -b -q W4Jet_JESDown_callHistoFillerTTbarProgression.cc
...
void W4Jet_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
