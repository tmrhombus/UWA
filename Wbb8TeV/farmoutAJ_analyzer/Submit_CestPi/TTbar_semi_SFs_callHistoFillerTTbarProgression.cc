...
Usage: 
root -l -b
.L TTbar_semi_SFs_callHistoFillerTTbarProgression.cc
TTbar_semi_SFs_callHistoFillerTTbarProgression()

root -l -b -q TTbar_semi_SFs_callHistoFillerTTbarProgression.cc
...
void TTbar_semi_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
