...
Usage: 
root -l -b
.L WZ_LESUp_callHistoFillerTTbarProgression.cc
WZ_LESUp_callHistoFillerTTbarProgression()

root -l -b -q WZ_LESUp_callHistoFillerTTbarProgression.cc
...
void WZ_LESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
