...
Usage: 
root -l -b
.L TTbar_full_JESDown_callHistoFillerTTbarProgression.cc
TTbar_full_JESDown_callHistoFillerTTbarProgression()

root -l -b -q TTbar_full_JESDown_callHistoFillerTTbarProgression.cc
...
void TTbar_full_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
