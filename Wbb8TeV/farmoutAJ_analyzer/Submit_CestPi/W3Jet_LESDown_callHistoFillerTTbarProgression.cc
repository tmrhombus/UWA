...
Usage: 
root -l -b
.L W3Jet_LESDown_callHistoFillerTTbarProgression.cc
W3Jet_LESDown_callHistoFillerTTbarProgression()

root -l -b -q W3Jet_LESDown_callHistoFillerTTbarProgression.cc
...
void W3Jet_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
