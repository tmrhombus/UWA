...
Usage: 
root -l -b
.L T_t_LESDown_callHistoFillerTTbarProgression.cc
T_t_LESDown_callHistoFillerTTbarProgression()

root -l -b -q T_t_LESDown_callHistoFillerTTbarProgression.cc
...
void T_t_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
