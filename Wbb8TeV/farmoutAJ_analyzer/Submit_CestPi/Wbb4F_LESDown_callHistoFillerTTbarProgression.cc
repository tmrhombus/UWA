...
Usage: 
root -l -b
.L Wbb4F_LESDown_callHistoFillerTTbarProgression.cc
Wbb4F_LESDown_callHistoFillerTTbarProgression()

root -l -b -q Wbb4F_LESDown_callHistoFillerTTbarProgression.cc
...
void Wbb4F_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
