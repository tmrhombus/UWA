...
Usage: 
root -l -b
.L T_t_SFs_callHistoFillerTTbarProgression.cc
T_t_SFs_callHistoFillerTTbarProgression()

root -l -b -q T_t_SFs_callHistoFillerTTbarProgression.cc
...
void T_t_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
