...
Usage: 
root -l -b
.L ZZ_JESDown_callHistoFillerTTbarProgression.cc
ZZ_JESDown_callHistoFillerTTbarProgression()

root -l -b -q ZZ_JESDown_callHistoFillerTTbarProgression.cc
...
void ZZ_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
