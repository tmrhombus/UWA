...
Usage: 
root -l -b
.L DataA_8TeVMu_callHistoFillerTTbarProgression.cc
DataA_8TeVMu_callHistoFillerTTbarProgression()

root -l -b -q DataA_8TeVMu_callHistoFillerTTbarProgression.cc
...
void DataA_8TeVMu_callHistoFillerTTbarProgression()
{
 int error = 0;
