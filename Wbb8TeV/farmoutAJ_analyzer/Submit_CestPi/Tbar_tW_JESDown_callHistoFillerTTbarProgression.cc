...
Usage: 
root -l -b
.L Tbar_tW_JESDown_callHistoFillerTTbarProgression.cc
Tbar_tW_JESDown_callHistoFillerTTbarProgression()

root -l -b -q Tbar_tW_JESDown_callHistoFillerTTbarProgression.cc
...
void Tbar_tW_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
