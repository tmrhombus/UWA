...
Usage: 
root -l -b
.L W4Jet_LESDown_callHistoFillerTTbarProgression.cc
W4Jet_LESDown_callHistoFillerTTbarProgression()

root -l -b -q W4Jet_LESDown_callHistoFillerTTbarProgression.cc
...
void W4Jet_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
