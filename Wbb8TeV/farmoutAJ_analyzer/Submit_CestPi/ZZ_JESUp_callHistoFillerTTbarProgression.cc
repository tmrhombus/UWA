...
Usage: 
root -l -b
.L ZZ_JESUp_callHistoFillerTTbarProgression.cc
ZZ_JESUp_callHistoFillerTTbarProgression()

root -l -b -q ZZ_JESUp_callHistoFillerTTbarProgression.cc
...
void ZZ_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
