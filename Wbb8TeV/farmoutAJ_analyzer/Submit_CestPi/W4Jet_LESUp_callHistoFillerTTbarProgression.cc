...
Usage: 
root -l -b
.L W4Jet_LESUp_callHistoFillerTTbarProgression.cc
W4Jet_LESUp_callHistoFillerTTbarProgression()

root -l -b -q W4Jet_LESUp_callHistoFillerTTbarProgression.cc
...
void W4Jet_LESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
