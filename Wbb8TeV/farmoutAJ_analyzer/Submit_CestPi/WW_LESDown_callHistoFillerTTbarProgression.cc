...
Usage: 
root -l -b
.L WW_LESDown_callHistoFillerTTbarProgression.cc
WW_LESDown_callHistoFillerTTbarProgression()

root -l -b -q WW_LESDown_callHistoFillerTTbarProgression.cc
...
void WW_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
