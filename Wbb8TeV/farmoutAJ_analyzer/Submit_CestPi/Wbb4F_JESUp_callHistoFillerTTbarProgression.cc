...
Usage: 
root -l -b
.L Wbb4F_JESUp_callHistoFillerTTbarProgression.cc
Wbb4F_JESUp_callHistoFillerTTbarProgression()

root -l -b -q Wbb4F_JESUp_callHistoFillerTTbarProgression.cc
...
void Wbb4F_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
