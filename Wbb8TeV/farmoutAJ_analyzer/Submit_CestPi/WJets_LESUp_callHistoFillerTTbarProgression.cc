...
Usage: 
root -l -b
.L WJets_LESUp_callHistoFillerTTbarProgression.cc
WJets_LESUp_callHistoFillerTTbarProgression()

root -l -b -q WJets_LESUp_callHistoFillerTTbarProgression.cc
...
void WJets_LESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
