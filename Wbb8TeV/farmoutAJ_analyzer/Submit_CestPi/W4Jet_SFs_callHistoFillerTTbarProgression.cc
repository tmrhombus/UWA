...
Usage: 
root -l -b
.L W4Jet_SFs_callHistoFillerTTbarProgression.cc
W4Jet_SFs_callHistoFillerTTbarProgression()

root -l -b -q W4Jet_SFs_callHistoFillerTTbarProgression.cc
...
void W4Jet_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
