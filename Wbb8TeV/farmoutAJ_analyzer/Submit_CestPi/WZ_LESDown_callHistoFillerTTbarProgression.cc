...
Usage: 
root -l -b
.L WZ_LESDown_callHistoFillerTTbarProgression.cc
WZ_LESDown_callHistoFillerTTbarProgression()

root -l -b -q WZ_LESDown_callHistoFillerTTbarProgression.cc
...
void WZ_LESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
