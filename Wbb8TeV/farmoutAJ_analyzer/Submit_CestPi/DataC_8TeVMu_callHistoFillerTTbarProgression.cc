...
Usage: 
root -l -b
.L DataC_8TeVMu_callHistoFillerTTbarProgression.cc
DataC_8TeVMu_callHistoFillerTTbarProgression()

root -l -b -q DataC_8TeVMu_callHistoFillerTTbarProgression.cc
...
void DataC_8TeVMu_callHistoFillerTTbarProgression()
{
 int error = 0;
