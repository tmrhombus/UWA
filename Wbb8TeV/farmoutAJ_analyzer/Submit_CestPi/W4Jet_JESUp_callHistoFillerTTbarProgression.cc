...
Usage: 
root -l -b
.L W4Jet_JESUp_callHistoFillerTTbarProgression.cc
W4Jet_JESUp_callHistoFillerTTbarProgression()

root -l -b -q W4Jet_JESUp_callHistoFillerTTbarProgression.cc
...
void W4Jet_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
