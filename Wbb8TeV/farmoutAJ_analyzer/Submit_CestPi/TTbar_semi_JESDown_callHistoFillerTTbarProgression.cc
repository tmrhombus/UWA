...
Usage: 
root -l -b
.L TTbar_semi_JESDown_callHistoFillerTTbarProgression.cc
TTbar_semi_JESDown_callHistoFillerTTbarProgression()

root -l -b -q TTbar_semi_JESDown_callHistoFillerTTbarProgression.cc
...
void TTbar_semi_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
