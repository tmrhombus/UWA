...
Usage: 
root -l -b
.L ZZ_SFs_callHistoFillerTTbarProgression.cc
ZZ_SFs_callHistoFillerTTbarProgression()

root -l -b -q ZZ_SFs_callHistoFillerTTbarProgression.cc
...
void ZZ_SFs_callHistoFillerTTbarProgression()
{
 int error = 0;
