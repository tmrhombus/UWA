...
Usage: 
root -l -b
.L W2Jet_JESDown_callHistoFillerTTbarProgression.cc
W2Jet_JESDown_callHistoFillerTTbarProgression()

root -l -b -q W2Jet_JESDown_callHistoFillerTTbarProgression.cc
...
void W2Jet_JESDown_callHistoFillerTTbarProgression()
{
 int error = 0;
