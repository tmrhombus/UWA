...
Usage: 
root -l -b
.L WZ_JESUp_callHistoFillerTTbarProgression.cc
WZ_JESUp_callHistoFillerTTbarProgression()

root -l -b -q WZ_JESUp_callHistoFillerTTbarProgression.cc
...
void WZ_JESUp_callHistoFillerTTbarProgression()
{
 int error = 0;
