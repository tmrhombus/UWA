...
class CompositePtrCandidateT1T2MEt : public reco::LeafCandidate
{
 ...
 public:
  ...
  reco::Candidate::LorentzVector p4Higgs() const { return p4Higgs_; }
  reco::Candidate::LorentzVector p4HiggsSV() const { return p4HiggsSV_; }
 ...
 private:
  ...
  //Set Higgs Quantities
  void setHiggs(const reco::Candidate::LorentzVector& p4) { p4Higgs_ = p4; }
  void setHiggsSV(const reco::Candidate::LorentzVector& p4) { p4HiggsSV_ = p4; }
  ...
  /// gen. four-momenta
  reco::Candidate::LorentzVector p4Higgs_;
  reco::Candidate::LorentzVector p4HiggsSV_;
