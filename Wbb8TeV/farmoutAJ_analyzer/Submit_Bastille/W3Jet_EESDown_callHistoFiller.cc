...
Usage: 
root -l -b
.L W3Jet_EESDown_callHistoFiller.cc
W3Jet_EESDown_callHistoFiller()

root -l -b -q W3Jet_EESDown_callHistoFiller.cc
...
void W3Jet_EESDown_callHistoFiller()
{
 int error = 0;
...
// TChain *theChainLESDown = new TChain("muEleEventTreeMuonDown/eventTree");
 ...
 TString sample="W3Jet";
 UInt_t nrEvents = 30358906 ;
