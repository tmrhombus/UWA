...
Usage: 
root -l -b
.L TTbar_full_EESDown_callHistoFiller.cc
TTbar_full_EESDown_callHistoFiller()

root -l -b -q TTbar_full_EESDown_callHistoFiller.cc
...
void TTbar_full_EESDown_callHistoFiller()
{
 int error = 0;
...
// TChain *theChainLESDown = new TChain("muEleEventTreeMuonDown/eventTree");
 ...
 TChain *theChain = new TChain("muEleEventTreeElectronDown/eventTree");
