...
Usage: 
root -l -b
.L W4Jet_EESDown_callHistoFiller.cc
W4Jet_EESDown_callHistoFiller()

root -l -b -q W4Jet_EESDown_callHistoFiller.cc
...
void W4Jet_EESDown_callHistoFiller()
{
 int error = 0;
...
// TChain *theChainLESDown = new TChain("muEleEventTreeMuonDown/eventTree");
 ...
 TString sample="W4Jet";
 UInt_t nrEvents = 13042592 ;
