...
Usage: 
root -l -b
.L WJets_EESDown_callHistoFiller.cc
WJets_EESDown_callHistoFiller()

root -l -b -q WJets_EESDown_callHistoFiller.cc
...
void WJets_EESDown_callHistoFiller()
{
 int error = 0;
