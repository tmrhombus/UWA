...
Usage: 
root -l -b
.L Tbar_t_EESDown_callHistoFiller.cc
Tbar_t_EESDown_callHistoFiller()

root -l -b -q Tbar_t_EESDown_callHistoFiller.cc
...
void Tbar_t_EESDown_callHistoFiller()
{
 int error = 0;
