...
Usage: 
root -l -b
.L WW_EESDown_callHistoFiller.cc
WW_EESDown_callHistoFiller()

root -l -b -q WW_EESDown_callHistoFiller.cc
...
void WW_EESDown_callHistoFiller()
{
 int error = 0;
...
// TChain *theChainLESDown = new TChain("muEleEventTreeMuonDown/eventTree");
 ...
 TString sample="WW";
 UInt_t nrEvents = 10000431 ;
 Float_t crossSec = 56.0 ;
