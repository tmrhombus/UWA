...
Usage: 
root -l -b
.L Tbar_s_EESDown_callHistoFiller.cc
Tbar_s_EESDown_callHistoFiller()

root -l -b -q Tbar_s_EESDown_callHistoFiller.cc
...
void Tbar_s_EESDown_callHistoFiller()
{
 int error = 0;
...
// TChain *theChainLESDown = new TChain("muEleEventTreeMuonDown/eventTree");
 ...
 TString sample="Tbar_s";
 UInt_t nrEvents = 139974 ;
 Float_t crossSec = 1.76 ;
