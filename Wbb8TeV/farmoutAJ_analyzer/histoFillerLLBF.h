#ifndef histoFillerLLBF_h
#define histoFillerLLBF_h
...
class histoFillerLLBF {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

   // Histograms
   std::vector<TString> PSpace;  // 2 llbf_t llbf_m
   std::vector<TString> EMu;     // 2
   std::vector<TString> QCD;     // 2
   std::vector<TString> Syst;    // 1
   std::vector<TString> WFlav;   // 5
   TH1F hists_met[2][2][2][1][5];
   TH1F hists_met_phi[2][2][2][1][5];
   TH1F hists_mt[2][2][2][1][5];
   TH1F hists_goodLep_pt[2][2][2][1][5];
   TH1F hists_goodJ1_pt[2][2][2][1][5];
   TH1F hists_goodJ2_pt[2][2][2][1][5];
   TH1F hists_goodJ1J2_dR[2][2][2][1][5];
   TH1F hists_goodJ1J2_mass[2][2][2][1][5];
   TH1F hists_goodJ1J2_pt[2][2][2][1][5];
   TH1F hists_goodJ1_CSV[2][2][2][1][5];
   TH1F hists_goodJ1_mass_SV_unweighted[2][2][2][1][5];
   TH1F hists_goodJ1_mass_SV_corrected[2][2][2][1][5];
   TH1F hists_goodJ1_mass_SV_weighted[2][2][2][1][5];
   TH1F hists_goodJ2_CSV[2][2][2][1][5]; 
   TH1F hists_goodJ3J4_mass[2][2][2][1][5]; 
   TH1F hists_vertices[2][2][2][1][5]; 
   TH1F hists_diMu_pt[2][2][2][1][5]; 
   TH1F hists_diMu_eta[2][2][2][1][5]; 
   TH1F hists_diMu_phi[2][2][2][1][5]; 
   TH1F hists_diMu_mass[2][2][2][1][5]; 
   TH1F hists_diEle_pt[2][2][2][1][5]; 
   TH1F hists_diEle_eta[2][2][2][1][5]; 
   TH1F hists_diEle_phi[2][2][2][1][5]; 
   TH1F hists_diEle_mass[2][2][2][1][5]; 
   ...
   Float_t SF_mmbf_IDIsoHLT ;
   Float_t SF_eebf_IDIsoHLT ;

   Float_t weight_mmbf_t ;
   Float_t weight_mmbf_m ;
   Float_t weight_eebf_t ;
   Float_t weight_eebf_m ;
   ...
   histoFillerLLBF(TTree *tree=0, Bool_t isMC=kTRUE);
   virtual ~histoFillerLLBF();
...
#ifdef histoFillerLLBF_cxx
histoFillerLLBF::histoFillerLLBF(TTree *tree, Bool_t isMC) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/tperry/Schweincomp/Schweincomp_Drell-mergeFilesJob/mergeFilesJob-MuEle-PATMCs-patTuple_cfg-00037C53-AAD1-E111-B1BE-003048D45F38.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/tperry/Schweincomp/Schweincomp_Drell-mergeFilesJob/mergeFilesJob-MuEle-PATMCs-patTuple_cfg-00037C53-AAD1-E111-B1BE-003048D45F38.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/tperry/Schweincomp/Schweincomp_Drell-mergeFilesJob/mergeFilesJob-MuEle-PATMCs-patTuple_cfg-00037C53-AAD1-E111-B1BE-003048D45F38.root:/muEleEventTree");
...
histoFillerLLBF::~histoFillerLLBF()
{
   if (!fChain) return;
...
Int_t histoFillerLLBF::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t histoFillerLLBF::LoadTree(Long64_t entry)
{
...
void histoFillerLLBF::Init(TTree *tree, Bool_t isMC)
{
   ...
   Syst.clear();
   WFlav.clear();
   PSpace.push_back("llbf_t");
   PSpace.push_back("llbf_m");
   EMu.push_back("mu");
   EMu.push_back("ele");
   QCD.push_back("good");
   //QCD.push_back("qcd");
     ...
     for(unsigned int k=0; k<QCD.size(); ++k){
      for(unsigned int l=0; l<Syst.size(); ++l){
       for(unsigned int m=0; m<WFlav.size(); ++m){
        ...
        TString histoname_diMu_pt = "h_"+PSpace[i]+"_"+EMu[j]+"_"+QCD[k]+"_diMu_pt"+Syst[l]+WFlav[m];
        TString histoname_diMu_eta = "h_"+PSpace[i]+"_"+EMu[j]+"_"+QCD[k]+"_diMu_eta"+Syst[l]+WFlav[m];
        TString histoname_diMu_phi = "h_"+PSpace[i]+"_"+EMu[j]+"_"+QCD[k]+"_diMu_phi"+Syst[l]+WFlav[m];
        TString histoname_diMu_mass = "h_"+PSpace[i]+"_"+EMu[j]+"_"+QCD[k]+"_diMu_mass"+Syst[l]+WFlav[m];
        TString histoname_diEle_pt = "h_"+PSpace[i]+"_"+EMu[j]+"_"+QCD[k]+"_diEle_pt"+Syst[l]+WFlav[m];
        TString histoname_diEle_eta = "h_"+PSpace[i]+"_"+EMu[j]+"_"+QCD[k]+"_diEle_eta"+Syst[l]+WFlav[m];
        TString histoname_diEle_phi = "h_"+PSpace[i]+"_"+EMu[j]+"_"+QCD[k]+"_diEle_phi"+Syst[l]+WFlav[m];
        TString histoname_diEle_mass = "h_"+PSpace[i]+"_"+EMu[j]+"_"+QCD[k]+"_diEle_mass"+Syst[l]+WFlav[m];
        ...
        hists_diMu_pt[i][j][k][l][m].Clear();
        hists_diMu_pt[i][j][k][l][m] = TH1F(histoname_diMu_pt, "pt(mu,mu)", 40, 0., 200.);
        hists_diMu_pt[i][j][k][l][m].Sumw2();                                               

        hists_diMu_eta[i][j][k][l][m].Clear();
        hists_diMu_eta[i][j][k][l][m] = TH1F(histoname_diMu_eta, "eta(mu,mu)", 20, -3., 5.);
        hists_diMu_eta[i][j][k][l][m].Sumw2();                                               

        hists_diMu_phi[i][j][k][l][m].Clear();
        hists_diMu_phi[i][j][k][l][m] = TH1F(histoname_diMu_phi, "phi(mu,mu)", 35, -3.4033, 5.7594);
        hists_diMu_phi[i][j][k][l][m].Sumw2();                                               

        hists_diMu_mass[i][j][k][l][m].Clear();
        hists_diMu_mass[i][j][k][l][m] = TH1F(histoname_diMu_mass, "mass(mu,mu)", 24, 0., 120.);
        hists_diMu_mass[i][j][k][l][m].Sumw2();                                               

        hists_diEle_pt[i][j][k][l][m].Clear();
        hists_diEle_pt[i][j][k][l][m] = TH1F(histoname_diEle_pt, "pt(ele,ele)", 40, 0., 200.);
        hists_diEle_pt[i][j][k][l][m].Sumw2();                                               

        hists_diEle_eta[i][j][k][l][m].Clear();
        hists_diEle_eta[i][j][k][l][m] = TH1F(histoname_diEle_eta, "eta(ele,ele)", 20, -3., 5.);
        hists_diEle_eta[i][j][k][l][m].Sumw2();                                               

        hists_diEle_phi[i][j][k][l][m].Clear();
        hists_diEle_phi[i][j][k][l][m] = TH1F(histoname_diEle_phi, "phi(ele,ele)", 35, -3.4033, 5.7594);
        hists_diEle_phi[i][j][k][l][m].Sumw2();                                               

        hists_diEle_mass[i][j][k][l][m].Clear();
        hists_diEle_mass[i][j][k][l][m] = TH1F(histoname_diEle_mass, "mass(ele,ele)", 24, 0., 120.);
        hists_diEle_mass[i][j][k][l][m].Sumw2();                                               
...
void histoFillerLLBF::Show(Long64_t entry)
{
...
double histoFillerLLBF::dPhi(double phi1, double phi2){
 double dphi;
...
double histoFillerLLBF::dEta(double eta1, double eta2){
 double deta;
 deta = std::abs(eta1-eta2);
 return deta;
}

Bool_t histoFillerLLBF::FillHistograms(int i, int j, int k, int l, int m, double metval, double metphival, double mt, double lep_pt, double weight){
 ...
 hists_diMu_pt[i][j][k][l][m].Fill(diMu_pt,weight);
 hists_diMu_eta[i][j][k][l][m].Fill(diMu_eta,weight);
 hists_diMu_phi[i][j][k][l][m].Fill(diMu_phi,weight);
 hists_diMu_mass[i][j][k][l][m].Fill(diMu_mass,weight);
 hists_diEle_pt[i][j][k][l][m].Fill(diEle_pt,weight);
 hists_diEle_eta[i][j][k][l][m].Fill(diEle_eta,weight);
 hists_diEle_phi[i][j][k][l][m].Fill(diEle_phi,weight);
 hists_diEle_mass[i][j][k][l][m].Fill(diEle_mass,weight);
 return kTRUE;
}
Bool_t histoFillerLLBF::WriteHistograms(int i, int j, int k, int l, int m){
 ...
 hists_diMu_pt[i][j][k][l][m].Write();   
 hists_diMu_eta[i][j][k][l][m].Write();  
 hists_diMu_phi[i][j][k][l][m].Write();  
 hists_diMu_mass[i][j][k][l][m].Write(); 
 hists_diEle_pt[i][j][k][l][m].Write();  
 hists_diEle_eta[i][j][k][l][m].Write(); 
 hists_diEle_phi[i][j][k][l][m].Write(); 
 hists_diEle_mass[i][j][k][l][m].Write();
 return kTRUE;
}
Bool_t histoFillerLLBF::DeleteHistograms(int i, int j, int k, int l, int m){
 ...
 hists_diMu_pt[i][j][k][l][m].Delete();   
 hists_diMu_eta[i][j][k][l][m].Delete();  
 hists_diMu_phi[i][j][k][l][m].Delete();  
 hists_diMu_mass[i][j][k][l][m].Delete(); 
 hists_diEle_pt[i][j][k][l][m].Delete();  
 hists_diEle_eta[i][j][k][l][m].Delete(); 
 hists_diEle_phi[i][j][k][l][m].Delete(); 
 hists_diEle_mass[i][j][k][l][m].Delete();
 return kTRUE;
}

Bool_t histoFillerLLBF::fillHistWriter(
...
Bool_t histoFillerLLBF::writeHistWriter( int pspace_nr, int syst_nr, Bool_t isW ){
...
#endif // #ifdef histoFillerLLBF_cxx
