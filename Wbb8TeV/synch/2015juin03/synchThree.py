...
print(       "http://www.hep.wisc.edu/~tperry/wbb/synch/2015june03/%s%s%s_comp.log"%(cut,xn,xnj))
log = open('/afs/hep.wisc.edu/home/tperry/www/wbb/synch/2015june03/%s%s%s_comp.log'%(cut,xn,xnj),'w')
