...
def addMuNuEventTreePtDat(process,name,src = 'wCandsJets',srcZ = 'diMuonsSorted'):
   ...
   eventTree = cms.EDAnalyzer('EventTreeMaker',
                              ...
                              muNuJ2mu2 = cms.PSet(
                               ...
                               #muNuSecondJetSmplDisc = cms.PSet(
                               #    pluginType = cms.string("PATMuonNuPairPtJetVarFiller"),
                               #    src = cms.InputTag(src),
                               #    tag = cms.string("secondJetSmplDisc"),
                               #    method = cms.string("userFloat('fullDiscriminant')"),
                               #    rank = cms.untracked.double(1)
                               #),
                               #muNuSecondJetFullDisc = cms.PSet(
                               #    pluginType = cms.string("PATMuonNuPairPtJetVarFiller"),
                               #    src = cms.InputTag(src),
                               #    tag = cms.string("secondJetFullDisc"),
                               #    method = cms.string("userFloat('fullDiscriminant')"),
                               #    rank = cms.untracked.double(1)
                               #),
                               #muNuFirstJetSmplDisc = cms.PSet(
                               #    pluginType = cms.string("PATMuonNuPairPtJetVarFiller"),
                               #    src = cms.InputTag(src),
                               #    tag = cms.string("highestJetSmplDisc"),
                               #    method = cms.string("userFloat('fullDiscriminant')"),
                               #    rank = cms.untracked.double(0)
                               #),
                               #muNuFirstJetFullDisc = cms.PSet(
                               #    pluginType = cms.string("PATMuonNuPairPtJetVarFiller"),
                               #    src = cms.InputTag(src),
                               #    tag = cms.string("highestJetFullDisc"),
                               #    method = cms.string("userFloat('fullDiscriminant')"),
                               #    rank = cms.untracked.double(0)
                               #),
...
def addMuNuEventTreePtMC(process,name,src = 'wCandsJets',srcZ = 'diMuonsSorted',lhep="externalLHEProducer"):
   process.TFileService = cms.Service("TFileService", fileName = cms.string("analysis.root") )
   eventTree = cms.EDAnalyzer('EventTreeMaker',
                              coreCollections = cms.VInputTag(
                                   cms.InputTag(src)
