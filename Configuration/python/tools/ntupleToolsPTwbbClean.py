...
def makeMETobjects(srcGoodElectrons='smearedGoodElectrons', srcQCDElectrons='smearedQCDElectrons',
   ...
   metObjects = cms.PSet(
    ...
    mt_goodElectron = makeElectron('mt_electron','userFloat("mt")',sourceElectrons=srcGoodElectrons,lo=True),
    mt_goodElectron_eesUp = makeElectron('mt_electron_eesUp','userFloat("mt_eesUp")',sourceElectrons=srcGoodElectrons,lo=True),
    mt_goodElectron_eesDn = makeElectron('mt_electron_eesDn','userFloat("mt_eesDn")',sourceElectrons=srcGoodElectrons,lo=True),
    mt_goodElectron_uesUp = makeElectron('mt_electron_uesUp','userFloat("mt_uesUp")',sourceElectrons=srcGoodElectrons,lo=True),
    mt_goodElectron_uesDn = makeElectron('mt_electron_uesDn','userFloat("mt_uesDn")',sourceElectrons=srcGoodElectrons,lo=True),
    mt_goodElectron_jesUp = makeElectron('mt_electron_jesUp','userFloat("mt_jesUp")',sourceElectrons=srcGoodElectrons,lo=True),
    mt_goodElectron_jesDn = makeElectron('mt_electron_jesDn','userFloat("mt_jesDn")',sourceElectrons=srcGoodElectrons,lo=True),
    mt_goodMuon = makeMuon('mt_muon','userFloat("mt")',sourceMuons=srcGoodMuons,lo=True),
    mt_goodMuon_eesUp = makeMuon('mt_muon_eesUp','userFloat("mt_eesUp")',sourceMuons=srcGoodMuons,lo=True),
    mt_goodMuon_eesDn = makeMuon('mt_muon_eesDn','userFloat("mt_eesDn")',sourceMuons=srcGoodMuons,lo=True),
    mt_goodMuon_uesUp = makeMuon('mt_muon_uesUp','userFloat("mt_uesUp")',sourceMuons=srcGoodMuons,lo=True),
    mt_goodMuon_uesDn = makeMuon('mt_muon_uesDn','userFloat("mt_uesDn")',sourceMuons=srcGoodMuons,lo=True),
    mt_goodMuon_jesUp = makeMuon('mt_muon_jesUp','userFloat("mt_jesUp")',sourceMuons=srcGoodMuons,lo=True),
    mt_goodMuon_jesDn = makeMuon('mt_muon_jesDn','userFloat("mt_jesDn")',sourceMuons=srcGoodMuons,lo=True),

    mt_qcdElectron = makeElectron('mt_electron','userFloat("mt")',sourceElectrons=srcQCDElectrons,lo=True),
    mt_qcdElectron_eesUp = makeElectron('mt_electron_eesUp','userFloat("mt_eesUp")',sourceElectrons=srcQCDElectrons,lo=True),
    mt_qcdElectron_eesDn = makeElectron('mt_electron_eesDn','userFloat("mt_eesDn")',sourceElectrons=srcQCDElectrons,lo=True),
    mt_qcdElectron_uesUp = makeElectron('mt_electron_uesUp','userFloat("mt_uesUp")',sourceElectrons=srcQCDElectrons,lo=True),
    mt_qcdElectron_uesDn = makeElectron('mt_electron_uesDn','userFloat("mt_uesDn")',sourceElectrons=srcQCDElectrons,lo=True),
    mt_qcdElectron_jesUp = makeElectron('mt_electron_jesUp','userFloat("mt_jesUp")',sourceElectrons=srcQCDElectrons,lo=True),
    mt_qcdElectron_jesDn = makeElectron('mt_electron_jesDn','userFloat("mt_jesDn")',sourceElectrons=srcQCDElectrons,lo=True),
    mt_qcdMuon = makeMuon('mt_muon','userFloat("mt")',sourceMuons=srcQCDMuons,lo=True),
    mt_qcdMuon_eesUp = makeMuon('mt_muon_eesUp','userFloat("mt_eesUp")',sourceMuons=srcQCDMuons,lo=True),
    mt_qcdMuon_eesDn = makeMuon('mt_muon_eesDn','userFloat("mt_eesDn")',sourceMuons=srcQCDMuons,lo=True),
    mt_qcdMuon_uesUp = makeMuon('mt_muon_uesUp','userFloat("mt_uesUp")',sourceMuons=srcQCDMuons,lo=True),
    mt_qcdMuon_uesDn = makeMuon('mt_muon_uesDn','userFloat("mt_uesDn")',sourceMuons=srcQCDMuons,lo=True),
    mt_qcdMuon_jesUp = makeMuon('mt_muon_jesUp','userFloat("mt_jesUp")',sourceMuons=srcQCDMuons,lo=True),
    mt_qcdMuon_jesDn = makeMuon('mt_muon_jesDn','userFloat("mt_jesDn")',sourceMuons=srcQCDMuons,lo=True),
   )
   return metObjects
...
def makeScaleFactors(srcGoodElectrons='smearedGoodElectrons', srcQCDElectrons='smearedQCDElectrons',
  ...
  scaleFactors = cms.PSet(
    ...
    SF_goodEle_HLT = makeElectron(tagName="SF_goodEle_HLT", methodName="userFloat('SF_HLT')", sourceElectrons=srcGoodElectrons, lo=True),
    SF_goodEle_HLT_errUp = makeElectron(tagName="SF_goodEle_HLT_errUp", methodName="userFloat('SF_HLT_errUp')", sourceElectrons=srcGoodElectrons, lo=True),
    SF_goodEle_HLT_errDn = makeElectron(tagName="SF_goodEle_HLT_errDn", methodName="userFloat('SF_HLT_errDn')", sourceElectrons=srcGoodElectrons, lo=True),
    SF_goodEle_total = makeElectron(tagName="SF_goodEle_total", methodName="userFloat('SF_total')", sourceElectrons=srcGoodElectrons, lo=False),
    SF_goodEle_total_errUp = makeElectron(tagName="SF_goodEle_total_errUp", methodName="userFloat('SF_total_errUp')", sourceElectrons=srcGoodElectrons, lo=False),
    SF_goodEle_total_errDn = makeElectron(tagName="SF_goodEle_total_errDn", methodName="userFloat('SF_total_errDn')", sourceElectrons=srcGoodElectrons, lo=False),
    ...
    SF_goodMu_Iso = makeMuon(tagName="SF_goodMu_Iso", methodName="userFloat('SF_Iso')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_Iso_errUp = makeMuon(tagName="SF_goodMu_Iso_errUp", methodName="userFloat('SF_Iso_errUp')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_Iso_errDn = makeMuon(tagName="SF_goodMu_Iso_errDn", methodName="userFloat('SF_Iso_errDn')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_ID = makeMuon(tagName="SF_goodMu_ID", methodName="userFloat('SF_ID')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_ID_errUp = makeMuon(tagName="SF_goodMu_ID_errUp", methodName="userFloat('SF_ID_errUp')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_ID_errDn = makeMuon(tagName="SF_goodMu_ID_errDn", methodName="userFloat('SF_ID_errDn')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_HLT = makeMuon(tagName="SF_goodMu_HLT", methodName="userFloat('SF_HLT')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_HLT_errUp = makeMuon(tagName="SF_goodMu_HLT_errUp", methodName="userFloat('SF_HLT_errUp')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_HLT_errDn = makeMuon(tagName="SF_goodMu_HLT_errDn", methodName="userFloat('SF_HLT_errDn')", sourceMuons=srcGoodMuons, lo=True),
    SF_goodMu_total = makeMuon(tagName="SF_goodMu_total", methodName="userFloat('SF_total')", sourceMuons=srcGoodMuons, lo=False),
    SF_goodMu_total_errUp = makeMuon(tagName="SF_goodMu_total_errUp", methodName="userFloat('SF_total_errUp')", sourceMuons=srcGoodMuons, lo=False),
    SF_goodMu_total_errDn = makeMuon(tagName="SF_goodMu_total_errDn", methodName="userFloat('SF_total_errDn')", sourceMuons=srcGoodMuons, lo=False),

    SF_qcdMu_Iso = makeMuon(tagName="SF_qcdMu_Iso", methodName="userFloat('SF_Iso')", sourceMuons=srcQCDMuons, lo=True),
    SF_qcdMu_Iso_errUp = makeMuon(tagName="SF_qcdMu_Iso_errUp", methodName="userFloat('SF_Iso_errUp')", sourceMuons=srcQCDMuons, lo=True),
    SF_qcdMu_Iso_errDn = makeMuon(tagName="SF_qcdMu_Iso_errDn", methodName="userFloat('SF_Iso_errDn')", sourceMuons=srcQCDMuons, lo=True),
    SF_qcdMu_ID = makeMuon(tagName="SF_qcdMu_ID", methodName="userFloat('SF_ID')", sourceMuons=srcQCDMuons, lo=True),
    SF_qcdMu_ID_errUp = makeMuon(tagName="SF_qcdMu_ID_errUp", methodName="userFloat('SF_ID_errUp')", sourceMuons=srcQCDMuons, lo=True),
    SF_qcdMu_ID_errDn = makeMuon(tagName="SF_qcdMu_ID_errDn", methodName="userFloat('SF_ID_errDn')", sourceMuons=srcQCDMuons, lo=True),
