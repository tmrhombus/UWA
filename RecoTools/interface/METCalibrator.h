...
class METCalibrator  {
    ...
    shiftRes_(iConfig.getUntrackedParameter<double>("shiftRes",0.0))
  {
    ...
    if(calibrationScheme_.find("Phil") == 0 ) {
      ...
      edm::FileInPath fileDZ0("UWAnalysis/Configuration/data/recoilfit_datamm52X_0jet.root");
      edm::FileInPath fileDZ1("UWAnalysis/Configuration/data/recoilfit_datamm52X_1jet.root");
      edm::FileInPath fileDZ2("UWAnalysis/Configuration/data/recoilfit_datamm52X_2jet.root");
      edm::FileInPath fileZ0("UWAnalysis/Configuration/data/recoilfit_zmm52X_0jet.root");
      edm::FileInPath fileZ1("UWAnalysis/Configuration/data/recoilfit_zmm52X_1jet.root");
      edm::FileInPath fileZ2("UWAnalysis/Configuration/data/recoilfit_zmm52X_2jet.root");
